...
export class DashboardComponent implements OnInit {
  ...
  /**
   * A função init() incializa a API de gráficos com delay de 1 segundo, o que permite
   * a integração da API com o Angular.
   * @return void
   */
  init(): void {
  ...
  /**Cria e retorna o objeto DataTable da API de gráficos, responsável por definir os dados gráficos*/
  obterDataTable(): any {
